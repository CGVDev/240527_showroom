...
export const Content3DStage1 = ()=>{
    ...
    return(
        <Main3D>
            <Content3D>
                {
                    state.radialProject && state.stage === Stage.STAGE_1 && <RadialMenuView tickitems={[ ProjectOptions.INTEREST, ProjectOptions.DAYTIME ] } callback={ changeRadialProjectOption }/>
                }
                {
                    // state.radialAmenities && state.stage === Stage.STAGE_1 && <RadialMenuView tickitems={[ AmenitiesOptions.PLACES ] } callback={ changeRadialAmenitiesOption }/>
                }
                <PreWrapper>
                <Wrapper3D>
                    <Canvas

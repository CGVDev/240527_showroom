...
export const DepartmentModel = ({ baseColor, hoveredColor, department, animation, onClick=()=>{}, onDoubleClick=()=>{} })=>{
    

    const data = new DepartmentFactory().getGeometry(department.type);

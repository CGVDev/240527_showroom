...
export const Paginator = ({ currentPage, pageList, action, minPage=0, maxPage })=>{
    ...
    return(
        <PaginatorContainer>
            <ButtonPage className={ "control " +  ((currentPage === minPage) ? "inactive" : "") } onClick={ ()=>{ action(minPage) } }>
                <ButtonContainer>
                    <ButtonWrapper>
                        <ButtonText>
                            {"<"}
            ...
            <PagesContainer>
                {
                    pageTransition((animation, page)=>{
                        return(
                            <ButtonPage className={ (currentPage === page) ? "inactive" : "" } style={ animation } key={page} onClick={ ()=>{ action(page) } }>
                                <ButtonContainer>
                                    <ButtonWrapper>
                                        <ButtonText>
                                            { page + 1 }
            ...
            <ButtonPage className={ "control " + ((currentPage === (maxPage - 1)) ? "inactive" : "") } onClick={ ()=>{ action(maxPage - 1) } }>
                <ButtonContainer>
                    <ButtonWrapper>
                        <ButtonText>
                            {">"}
